...
<div class="min-height-200px">
   ...
   <div class="pd-20 card-box mb-30">
      <div class="clearfix">
         <div class="pull-left">
            <h2 class="text-primary h2"><i class="icon-copy dw dw-list"></i> List Data Majalah</h2>
         </div>
         <div class="pull-right">
            <a href="/admin/majalah/add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
         </div>
      </div>
      ...
      <table class="table table-striped table-bordered data-table hover">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  @if($item->file)
                     <a href="{{ asset('/public/majalah/'.$item->file) }}" target="_blank" class="btn btn-sm btn-info">
               ...
               <td class="text-center">
                  <a href="/admin/majalah/edit/{{ $item->id }}" class="btn btn-warning btn-sm">
      ...
      <div class="modal-content">
         <div class="modal-body">
            ...
            <div class="row mt-4">
               <div class="col-md-6">
                  <!-- Form Hapus -->
                  <form action="/admin/majalah/delete/{{$data->id}}" method="POST">
                     @csrf
                     @method('get')
